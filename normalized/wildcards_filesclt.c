...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/25 11:06:07 by jhvalenc          #+#    #+#             */
/*   Updated: 2026/02/25 11:06:59 by jhvalenc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Traverses all files in the current
 * directory stores their names into `files` */
int	wc_get_curdir_files_loop(DIR *dir, struct dirent *entry, char *files[],
								size_t *file_cnt)
{
	int	fret;
